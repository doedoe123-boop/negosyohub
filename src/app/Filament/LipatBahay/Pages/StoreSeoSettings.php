...
namespace App\Filament\LipatBahay\Pages;
...
class StoreSeoSettings extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.lipat-bahay.pages.store-seo-settings';
                ...
                Forms\Components\Section::make('Search Engine Optimisation')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('seo_keywords')
                            ->label('Meta Keywords')
                            ->maxLength(255)
                            ->helperText('Comma-separated keywords. Most search engines ignore this.')
                            ->columnSpanFull(),
                    ]),
