...
use App\Filament\Resources\WebhookEndpointResource\RelationManagers\DeliveriesRelationManager;
use App\Models\User;
...
class WebhookEndpointResource extends Resource
{
    ...
    public static function canAccess(): bool
    {
        ...
        return $user !== null && ! $user->isAdmin() && $user->getStoreForPanel() !== null;
    }
                ...
                Forms\Components\Section::make('Endpoint')
                    ->schema([
                        ...
                        Forms\Components\Hidden::make('store_id')
                            ->default(fn (): ?int => Auth::user()?->getStoreForPanel()?->id),
                    ])->columns(2),
            ]);
    }
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                ...
                Infolists\Components\Section::make('Delivery Summary')
                    ->schema([
